...
<div class="navbar navbar-fixed-left">
  <ul class="nav navbar-nav">
   ...
   <li class="active"><a href="myreport.php"><font color="white">Generate my report</font><br></a></li>
  </ul>
</div>
...
<div class="container">
        <br><br><br><br>
		<center><h3>Your report has been generated successfully! Download report to view report.<h3><br></center>
		<form name="reportform" action="pdfconv.php" method="post">
		<div class="form-group"><center>
        <button type="submit" class="btn button1" style="background-color:#43BFC7;border:0;"><font color="white">Download report</font></button></center>
		</div>
		</form>
</div>
</div>
