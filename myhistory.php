...
<div class="navbar navbar-fixed-left">
  <ul class="nav navbar-nav">
   ...
   <li class="active"><a href="myhistory.php"><font color="white">My History</font><br></a></li>
...
<table class="data-table"><br>
		...
		$result = mysql_query("SELECT Transaction_Id,sys,dias,predictions,Date FROM predictions p  where p.username='$uname' ");
        if (!$result) {
