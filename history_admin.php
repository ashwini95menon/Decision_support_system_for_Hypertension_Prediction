...
<head>
  ...
  .navbar-fixed-left .navbar-nav li a:hover {
	...
	table {
		...
		thead {
		width: calc( 80% - 1em )/* scrollbar is average 1em/16px width, remove it from thead width */
		}
...
<div class="navbar navbar-fixed-left">
  <ul class="nav navbar-nav">
   <li class="active"><a href="history_admin.php"><font color="white">All Patient History</font><br></a></li>
   <li><a href="hypertension_form_admin.php"><font color="white">Check Hypertension</font><br></a></li>
  </ul>
</div>

<div class="transbox">
<div id="s1">
<center><h3>Details of all the past hypertension checkups</h3></center>
<table class="data-table"><br>
		...
		$result = mysql_query("SELECT Transaction_Id,username,sys,dias,predictions,Date FROM predictions");
        if (!$result) {
