...
<div class="transbox">
    ...
    <li class="active"><a href="doctor_loginpage.php"><font color="black"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Doctor&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font></a></li>
    <li><a href="admin_loginpage.php"><font color="black"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Admin&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font></a></li>
    </ul>
    <br><br><br><br><br><br>
    <form role="form" name="loginform" action="loginvalid.php" method="post">
      ...
      <input type="hidden" name="usertype" id="usertype" value="D"><br><br>
